...
cdef int write_stats_header(TSVWriter* writer) except -1 nogil:
    ...
    tsv_append_string(writer, "read_gc_content_mean")
    tsv_append_string(writer, "read_gc_content_std")
    tsv_append_string(writer, "read_gc_content_total")
    tsv_append_string(writer, "ref_gc_content_mean")
    tsv_append_string(writer, "ref_gc_content_std")
    tsv_append_string(writer, "ref_gc_content_total")
    ...
    tsv_append_string(writer, "zp_mean")
    tsv_append_string(writer, "zp_std")
    tsv_append_string(writer, "zp_count")
    tsv_append_string(writer, "zs_mean")
    tsv_append_string(writer, "zs_std")
    tsv_append_string(writer, "zs_count")
    ...
    tsv_append_string(writer, "read_ani_corrected_mean")
    tsv_append_string(writer, "read_ani_corrected_std")
    ...
    tsv_append_string(writer, "mega_genome_sparsity_index")
    tsv_append_string(writer, "coverage_compressibility_ratio")
    tsv_append_string(writer, "feature_space_clustering_score")
    # Authenticity metrics
    tsv_append_string(writer, "authenticity_score")
    tsv_append_string(writer, "authenticity_pvalue")
    tsv_row_end(writer)
    return 0
...
cdef int write_stats_row(TSVWriter* writer, RefStats* stats, const char* ref_name) except -1 nogil:
    ...
    tsv_append_float(writer, stats.read_gc_content_mean, 4)
    tsv_append_float(writer, stats.read_gc_content_std, 4)
    tsv_append_float(writer, stats.read_gc_content_total, 4)
    tsv_append_float(writer, stats.ref_gc_content_mean, 4)
    tsv_append_float(writer, stats.ref_gc_content_std, 4)
    tsv_append_float(writer, stats.ref_gc_content_total, 4)
    ...
    # ZP/ZS stats (from reassign/EM output)
    tsv_append_float(writer, stats.zp_mean, 6)
    tsv_append_float(writer, stats.zp_std, 6)
    tsv_append_int(writer, stats.zp_count)
    tsv_append_float(writer, stats.zs_mean, 4)
    tsv_append_float(writer, stats.zs_std, 4)
    tsv_append_int(writer, stats.zs_count)
    ...
    tsv_append_float(writer, stats.ani_corrected_mean, 4)
    tsv_append_float(writer, stats.ani_corrected_std, 4)
    ...
    tsv_append_float(writer, stats.mega_genome_sparsity_index, 4)
    tsv_append_float(writer, stats.coverage_compressibility_ratio, 4)
    tsv_append_float(writer, stats.feature_space_clustering_score, 4)
    # Authenticity metrics
    tsv_append_float(writer, stats.authenticity_score, 4)
    tsv_append_float(writer, stats.authenticity_pvalue, 6)
    tsv_row_end(writer)
    return 0
